...
RD_API bool rd_reanalyze(RDContext* self);
...
RD_API bool rd_fill_nops(RDContext* self, RDAddress address, usize n);
...
RD_API bool rd_add_comment_before(RDContext* self, RDAddress address, const char* cmt);
RD_API bool rd_add_comment_after(RDContext* self, RDAddress address, const char* cmt);
