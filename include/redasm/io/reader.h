...
RD_API usize rd_reader_read(RDReader* self, void* v, usize n);
RD_API bool rd_reader_read_exact(RDReader* self, void* v, usize n);
RD_API bool rd_reader_read_byte(RDReader* self, u8* v);
...
RD_API bool rd_reader_read_uleb128(RDReader* self, RDULeb128* v);
RD_API bool rd_reader_read_sleb128(RDReader* self, RDSLeb128* v);
RD_API const char* rd_reader_read_str(RDReader* self, usize* len);
RD_API usize rd_reader_peek(RDReader* self, void* v, usize n);
RD_API bool rd_reader_peek_exact(RDReader* self, void* v, usize n);
RD_API bool rd_reader_peek_byte(const RDReader* self, u8* v);
...
RD_API bool rd_reader_peek_uleb128(const RDReader* self, RDULeb128* v);
RD_API bool rd_reader_peek_sleb128(const RDReader* self, RDSLeb128* v);
RD_API const char* rd_reader_peek_str(RDReader* self, usize* len);
RD_API bool rd_reader_expect_byte(RDReader* self, u8 v);
