...
RD_API bool rd_flagsbuffer_has_field(const RDFlagsBuffer* self, usize idx);
RD_API bool rd_flagsbuffer_has_item(const RDFlagsBuffer* self, usize idx);
...
RD_API bool rd_flagsbuffer_has_type(const RDFlagsBuffer* self, usize idx);
