...
RD_API bool rd_scratch_is_empty(const RDScratchBuffer* self);
...
RD_API const char* rd_scratch_first(const RDScratchBuffer* self);
RD_API const char* rd_scratch_last(const RDScratchBuffer* self);
