...
RD_API bool rd_typedef_get_args(const RDTypeDef* self, RDParamSlice* params);
RD_API bool rd_typedef_get_ret(const RDTypeDef* self, RDType* ret);
...
RD_API bool rd_typedef_is_proto(const RDTypeDef* self);
...
RD_API bool rd_typedef_set_proto(RDTypeDef* self, bool b);
